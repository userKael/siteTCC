                        ...
                        <li class="nav-item">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                        <form action="./perfil_do_usuario.php" method="post" class="text-center">
                                            <button type="submit" class="btn btn-outline-success" style="padding: 2px 49px 2px 49px;">Perfil</button>
                                        </form>

                                    </li>
                                    <hr class="m-2">
                                    <li>
                                        <form action="./PHP/deslogar.php" method="post" class="text-center">
                                            <button type="submit" class="btn btn-outline-danger" style="padding: 2px 43px 2px 43px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
